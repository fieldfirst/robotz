...
public class AddVariableDialog extends AddDialog {
	
	private static final long serialVersionUID = 1L;

	public AddVariableDialog(EditorJFrame frmMain) {
		super(frmMain);
	}
	...
	protected void initComponent() {
		...
		c.gridx = 0;
		c.gridy = 0;
		mainPanel.add(new JLabel("Variable name : "), c);
